	...
	<div id="wrapper"><!--wrapper start-->
		<div class="header-holder<?=($this->id=='site' && $this->action->id=='index')?'':' small';?>">
			<div id="header"><!--header start-->
				...
				<ul id="nav">
				    <li><a href="/#main"><span>Меню</span></a></li>
...
<div class="footer-holder">
	<div id="footer"><!--footer start-->
	    <br/><br/>
	    <div class="fb-like" data-href="https://www.facebook.com/Lpovar" data-send="false" data-width="450" data-show-faces="true" data-colorscheme="dark"></div>
		<?=$this->renderPartners();?>
